...
export default {
  ...
  data() {
    return {
      ...
      list: [
        {
          title: 'header.slide-1.title',
          subtitle: 'header.slide-1.subtitle',
        },
        {
          right: true,
          title: 'header.slide-2.title',
          subtitle: 'header.slide-2.subtitle',
        },
        {
          right: true,
          title: 'header.slide-3.title',
          subtitle: 'header.slide-3.subtitle',
        },
      ],
    }
  },
...
.VueCarousel-slide:nth-child(1) .item {
  background-image: url(/images/salade-2.jpg);
  background-position: bottom;
}

.VueCarousel-slide:nth-child(3) .item {
  background-image: url(/images/fresh-juice-3.jpg);
}

.VueCarousel-slide:nth-child(2) .item {
  background-image: url(/images/salade-3.jpg);
}
